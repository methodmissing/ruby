...
#define PROBE_VM_PUSH_FRAME_ENTRY() PROBE_ENTRY(VM_PUSH_FRAME)
#define PROBE_VM_PUSH_FRAME_RETURN() PROBE_RETURN(VM_PUSH_FRAME)
#define PROBE_VM_POP_FRAME_ENTRY() PROBE_ENTRY(VM_POP_FRAME)
#define PROBE_VM_POP_FRAME_RETURN() PROBE_RETURN(VM_POP_FRAME)