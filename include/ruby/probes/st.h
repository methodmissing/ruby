...
#define PROBE_ST_INIT_SIZED_NUMTABLE_BEGIN(size) PROBE_INT_BEGIN(ST_INIT_SIZED_NUMTABLE,size)
#define PROBE_ST_INIT_SIZED_NUMTABLE_END(size) PROBE_INT_END(ST_INIT_SIZED_NUMTABLE,size)
#define PROBE_ST_INIT_SIZED_STRTABLE_BEGIN(size) PROBE_INT_BEGIN(ST_INIT_SIZED_STRTABLE,size)
#define PROBE_ST_INIT_SIZED_STRTABLE_END(size) PROBE_INT_END(ST_INIT_SIZED_STRTABLE,size)
#define PROBE_ST_INIT_SIZED_STRCASETABLE_BEGIN(size) PROBE_INT_BEGIN(ST_INIT_SIZED_STRCASETABLE,size)
#define PROBE_ST_INIT_SIZED_STRCASETABLE_END(size) PROBE_INT_END(ST_INIT_SIZED_STRCASETABLE,size)
