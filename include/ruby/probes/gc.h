...
#define PROBE_GC_INIT_HEAP_ENTRY(objspace) PROBE_OBJSPACE_ENTRY(GC_ASSIGN_HEAP_SLOT,objspace)
#define PROBE_GC_INIT_HEAP_RETURN(objspace) PROBE_OBJSPACE_RETURN(GC_ASSIGN_HEAP_SLOT,objspace)