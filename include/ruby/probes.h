...
#define PROBE_METHOD_CALL_BEGIN() PROBE_BEGIN(METHOD_CALL)
#define PROBE_METHOD_CALL_END() PROBE_END(METHOD_CALL)
...
#define PROBE_BLOCK_CALL_BEGIN() PROBE_BEGIN(BLOCK_CALL)
#define PROBE_BLOCK_CALL_END() PROBE_END(BLOCK_CALL)
#else
...
#define PROBE_METHOD_CALL_BEGIN()
#define PROBE_METHOD_CALL_END()
...
#define PROBE_BLOCK_CALL_BEGIN()
#define PROBE_BLOCK_CALL_END()
#endif