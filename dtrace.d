provider ruby {
    ...
    probe vm__backtrace__entry(int level);
    probe vm__backtrace__return(int level);
    ...
    probe vm__block__call__entry(char *klass, char *method);
    probe vm__block__call__return(char *klass, char *method);
    ...
    probe vm__evalstr__entry(char *obj);
    probe vm__evalstr__return(char *obj);
    probe vm__instance__eval__entry(char *klass);
    probe vm__instance__eval__return(char *klass);
    probe vm__instance__exec__entry(char *klass);
    probe vm__instance__exec__return(char *klass);
    probe vm__module__eval__entry(char *klass);
    probe vm__module__eval__return(char *klass);
    probe vm__module__exec__entry(char *klass);
    probe vm__module__exec__return(char *klass);
    ...
    probe load_search__required__entry(char *file, char *path);
    probe load_search__required__return(char *file, char *path);
    probe load_find_file__entry(char *path);
    probe load_find_file__return(char *path);
    ...
    probe io__read__entry(int fd, long size);
